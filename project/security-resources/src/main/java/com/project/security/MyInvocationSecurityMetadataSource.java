...
import com.project.entity.RolePermission;
...
public class MyInvocationSecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
	...
	public Collection<ConfigAttribute> getAttributes(Object o) throws IllegalArgumentException {
		...
		// 去数据库查询资源
		List<Permission> allMenu = permissionMapper.findAll();
	...
	/**
	 * @Author: Galen
	 * @Description: 此处方法如果做了实现，返回了定义的权限资源列表， Spring
	 *               Security会在启动时校验每个ConfigAttribute是否配置正确，
	...
	/**
	 * @Author: Galen
	 * @Description: 方法返回类对象是否支持校验， web项目一般使用FilterInvocation来判断，或者直接返回true
